 ...
 *
 */
qx.Class.define("lou_extensions.widgets.UploadField",
    {
        ...
        {
            this.base(arguments);
            this._setLayout(new qx.ui.layout.Grid(9,5)
                .setColumnFlex(0,1)
        ...
        members :
        {
            ...
            _createChildControlImpl: function(id) {
                ...
                switch(id) {
                    case "button":
                        control = new lou_extensions.widgets.UploadButton(this.getFieldName(), this.getLabel(), this.getIcon());
                        control.setWidth(80);
